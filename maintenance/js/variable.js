...
/* dark overlay */
var _darkOverlayColor = 'rgba(10, 10, 10, 0.7)'; // [rgba format] - overlay color
var _darkFormOverlayColor = 'rgba(255, 255, 255, 0.8)'; // [rgba format] - form overlay color
...
text animation
==============================================================================*/
var _animationDuration = 1800; // animation duration

/*==============================================================================
countdown
==============================================================================*/
var _countdown = true; // countdown toggle
var _countdownDate = '3/24/2017 15:00:00'; // 2015-12-24 23:59:59
...
/*=================================================
_bgStyle = 1
  - replace background image at maintenance/img/bg/bg.jpg
=================================================*/
...
_bgStyle = 2
  - slideshow
=================================================*/
var _imgAmount = 7; // min = 2, how many image at slideshow, file name slideshow-01.jpg, slideshow-02.jpg...slideshow-10.jpg etc
