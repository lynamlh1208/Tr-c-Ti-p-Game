  ...
  function fn_subscribeForm() {
    ...
    $form.validate({
      ...
      submitHandler: function(form) {
        $(form).ajaxSubmit({
          type: 'POST',
          url: 'maintenance/php/subscribe.php',
          dataType: 'json',
          cache: false,
          data: $form.serialize(),
...
=================================================*/
  ...
  function fn_slider() {
    ...
    for (var i = 1; i <= _imgAmount; i++) {
      $('#img').append('<img src="maintenance/img/bg/slideshow-' + (i < 10 ? '0' + i : i) + '.jpg">');
    }
...
=================================================*/
  function fn_videoBg() {
    ...
    if (!isMobile) {
      $video.append('<video id="video-bg" autoplay loop><source src="maintenance/video/video.mp4" type="video/mp4"></video>');
      if (_videoMute) {
        var video = document.getElementById('video-bg');
        video.muted = true;
      }
